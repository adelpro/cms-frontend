 ...
 * ```
 */
export async function downloadAsset(assetId: number, token: string): Promise<DownloadResponseOut> {
 ...
 * ```
 */
export async function createResource(data: CreateResourceIn, token: string): Promise<ResourceOut> {
 ...
 * ```
 */
export async function deleteResource(resourceId: number, token: string): Promise<OkSchema> {
