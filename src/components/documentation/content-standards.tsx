  ...
  return (
    <div className='max-width-container px-4 py-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-8'>
        ...
        <div className='lg:col-span-3 space-y-8'>
          ...
          <div className='space-y-4'>
            <h1 className='text-4xl font-bold text-foreground'>{t('contentStandards.title')}</h1>
            <p className='text-lg text-muted-foreground'>{t('contentStandards.description')}</p>
      ...
      <div className='mt-12 pt-8 border-t border-gray-200'>
        <p className='text-center text-sm text-muted-foreground'>{t('contentStandards.footer')}</p>
      </div>
    </div>
  );
}
